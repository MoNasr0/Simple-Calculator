...
void M_Dio_PinMode(u8 Local_u8_Num,u8 Local_u8_Mode)  //direction   
{ 
...
void M_Dio_PinWrite(u8 Local_u8_Num,u8 Local_u8_Mode)   // output 
{
	u8 Local_u8_Pin  = Local_u8_Num % 10;
	u8 Local_u8_Port = Local_u8_Num / 10;
	switch(Local_u8_Mode)
...
void M_Dio_PortMode(u8 Local_u8_Port,u8 Local_u8_Mode)     // direction 
{
	switch(Local_u8_Mode)
	{
		case OUTPUT:
...
void M_Dio_PortWrite(u8 Local_u8_Port,u8 Local_u8_Value) // output
{
	switch(Local_u8_Port)
	{
